  ...
  return (
    <div className="page-container">
        ...
        >
          ...
          <div data-thq="thq-navbar-nav" className="page-desktop-menu">
            <nav className="page-links">
              ...
              <span className="page-nav22 bodySmall">Features</span>
              <span className="page-nav32 bodySmall">FAQ</span>
              <span className="page-nav42 bodySmall">Contact</span>
              <span className="page-nav421 bodySmall">MyLinks</span>
            </nav>
            <div className="page-buttons">
              <button className="page-logout buttonFlat">Logout</button>
            </div>
          </div>
          ...
          >
            <div className="page-nav">
              ...
              <nav className="page-links1">
                <span className="page-nav121 bodySmall">Home</span>
                <span className="page-nav221 bodySmall">Features</span>
                <span className="page-nav321 bodySmall">FAQ</span>
                <span className="page-nav422 bodySmall">Contact</span>
              </nav>
      ...
      <div className="page-hero">
        <div className="heroContainer page-hero1">
          <div className="page-container1">
            <h1 className="page-hero-heading heading1">My CutU Links</h1>
            <ul className="list">
        ...
        <footer className="footerContainer page-footer1">
          <div className="page-container3">
            ...
            <nav className="page-nav1">
              <span className="bodySmall">Home</span>
              <span className="page-nav222 bodySmall">Features</span>
              <span className="page-nav322 bodySmall">FAQ</span>
              <span className="page-nav423 bodySmall">Contact</span>
            </nav>
          </div>
          <div className="page-separator"></div>
          <div className="page-container4">
            <span className="bodySmall page-text3">
