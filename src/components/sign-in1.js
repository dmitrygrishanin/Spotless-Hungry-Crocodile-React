      ...
      <div className="sign-in1-max-width thq-section-max-width">
          ...
          <div className="sign-in1-form">
            ...
            <div className="sign-in1-container2">
              <div className="sign-in1-container3">
                ...
                >
                  <span className="sign-in1-text04 thq-body-small">
                    {props.action1}
                  </span>
                </button>
              ...
              <div className="sign-in1-container4">
                <span className="sign-in1-text08 thq-body-small">
                  Issues with Sign in
                </span>
                <span className="sign-in1-text09 thq-body-small">
                  Forgot password
                </span>
              </div>
            </div>
        ...
        <div className="sign-in1-container5">
          ...
          <button type="button" className="sign-in1-button1 thq-button-outline">
            <span className="sign-in1-text11 thq-body-small">
              {props.action2}
            </span>
          </button>
        </div>
